...
<p class='exzoom_preview'>
    ...
    function bindingEvent() {
        ...
        exzoom_img_ul.on("touchstart", function (event) {
            ...
            let right = exzoom_img_ul.css("right");
            exzoom_img_ul_position = parseInt(right);
        ...
        exzoom_img_ul.on("touchmove", function (event) {
            ...
            exzoom_img_ul.css("right", new_position);
        ...
        exzoom_zoom_outer.on("mouseup", function (event) {
            ...
            if (startX - offset.right < boxWidth / 2) {
                //在放大镜的左半部分点击
                moveLeft();
            } else if (startX - offset.right > boxWidth / 2) {
                //在放大镜的右半部分点击
                moveRight();
            }
        });
        ...
        exzoom_zoom_outer.on("mousemove", function (e) {
            let width_limit = exzoom_zoom.width() / 2, // 131
                max_X = exzoom_zoom_outer.width() - width_limit, // 391
            ...
            exzoom_zoom.css({"right": move_X + "px", "top": move_Y + "px"});
            // left = 261 / 0
